...
#    ttl_pulse("PMT trigger", 100.0)

#    dds_freq_sweep(4, "carrier", [0, 50, 100], [1, -1], 0.00089, 0.00089, 1, 100, loop_counts=0, is_last=True)


#    seq_wait(10)
        
#    dds_ampl_sweep(4, "clock1", [0, 50, 100], [1, -1], 0.0001, 0.0001, 0.0, 1.0, loop_counts=0, is_last=True)

#    seq_wait(10)

#    dds_phase_sweep(4, "carrier", [0.01, 100], [1], 0.025, 45, 0.0, 360.0, loop_counts=0, is_last=True)
...
#    rf_pulse(2.5,0,1,"carrier", 0.0, is_last=False, address=0)
...
#    rf_pulse(300,0,1,"carrier", 0.0, is_last=False, address=5)
#    rf_pulse(300,0,1,"carrier", 0.0, is_last=False, address=4)

#    rf_on(100.0, -15, 5)
#    rf_on(100.0, -15, 4)

#    rf_pulse(300,0,1,"carrier", 0.0, is_last=False, address=3)
#    rf_pulse(300,0,1,"carrier", 0.0, is_last=False, address=2)
#    rf_pulse(300,0,1,"carrier", 0.0, is_last=False, address=1)
#    rf_pulse(300,0,1,"carrier", 0.0, is_last=False, address=0)
