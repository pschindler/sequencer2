...
# Time-stamp: "11-Jän-2010 22:40:18 viellieb"
...
if __name__ == "__main__":
    ...
    parser.add_option("--sequencer2", action = "store_true", default=False,
                      help = "file is generated by sequencer2")
    (options, args) = parser.parse_args()
    
    if options.sequencer2:
        IS_SEQUENCER2 = True
    else:
        IS_SEQUENCER2 = False
